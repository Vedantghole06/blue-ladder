            ...
            <div className="team-section py-16 px-4 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {teamMembers.map((member) => (
                        <div key={member.id} className="team-card p-6 border border-gray-100 rounded-lg flex flex-col items-center text-center">
                            {/* Team Member Image */}
                            ...
                            <p className="text-sm text-gray-500 mb-6">{member.bio}</p>
