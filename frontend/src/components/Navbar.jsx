          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative" ref={aboutRef}>
              ...
              {aboutDropdownOpen && (
                <div className="absolute mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                  <NavLink to="/about/why-us" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Why Us</NavLink>
                  <NavLink to="/about/our-team" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Our Team</NavLink>
                  <NavLink to="/about/peb" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">What is PEB</NavLink>
                </div>
              )}
            </div>
            ...
            <div className="relative" ref={productsRef}>
              ...
              {productsDropdownOpen && (
                <div className="absolute mt-2 w-64 bg-white rounded-md shadow-lg py-1 z-10">
                  {/* PEB Sub-dropdown */}
                  ...
                  <NavLink to="/smart-and-green" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Smart & Green Buildings</NavLink>
                </div>
              )}
            </div>

            <NavLink to="/our-project" className="text-gray-700 hover:text-blue-600">Our Projects</NavLink>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200" ref={mobileMenuRef}>
            <div className="flex flex-col space-y-3">
              <NavLink to="/" className="text-gray-700 hover:text-blue-600 py-1">Home</NavLink>
              ...
              <div ref={mobileProductsRef}>
                ...
                {productsDropdownOpen && (
                  <div className="pl-4 mt-2 space-y-2">
                    ...
                    <NavLink to="/smart-and-green" className="block text-gray-700 hover:text-blue-600 py-1">Smart & Green Buildings</NavLink>
                  </div>
                )}
              </div>
